...
namespace Aictiq.Modules.Identity.Migrations
{
    ...
    public partial class InitialIdentity : Migration
    {
        ...
        {
            // Hand-written: extensions used across modules (trigram search, accent-insensitive
            // matching). Identity migrates first, so later modules can rely on them.
            ...
            // Hand-written: the audit trail is append-only at the database level. Even a
            // compromised app connection cannot rewrite history.
            migrationBuilder.Sql("""
                CREATE FUNCTION shared.reject_mutation() RETURNS trigger AS $$
                BEGIN
                ...
                FOR EACH ROW EXECUTE FUNCTION shared.reject_mutation();
                """);
        }
        ...
        {
            migrationBuilder.Sql("DROP FUNCTION IF EXISTS shared.reject_mutation() CASCADE;");
